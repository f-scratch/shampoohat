...
module Shampoohat
  module Build
    class SavonAbstractGenerator
      def initialize(args)
        if self.class() == Shampoohat::Build::SavonAbstractGenerator
      ...
      def prepare_template_strings()
        @generator_stamp = "Code generated by Shampoohat library %s on %s." %
            [Shampoohat::ApiConfig::CLIENT_LIB_VERSION,
