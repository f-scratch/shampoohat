...
class TestParametersValidator < Test::Unit::TestCase
  def setup
    @validator = Shampoohat::ParametersValidator.new(nil)
  end
  ...
  def test_check_required_argument_present
    ...
    assert_raises(Shampoohat::Errors::MissingPropertyError) do
      @validator.check_required_argument_present(nil, field1)
    end
    assert_raises(Shampoohat::Errors::TypeMismatchError) do
